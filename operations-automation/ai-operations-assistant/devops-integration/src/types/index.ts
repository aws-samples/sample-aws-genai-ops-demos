...
// ─── Agent Integration Template Props ───────────────────────────────────────
...
export interface AgentIntegrationTemplateProps {
   ...
   */
  lambdaCode?: unknown; // aws-cdk-lib.aws-lambda.Code — typed as unknown to avoid circular deps
  /**
