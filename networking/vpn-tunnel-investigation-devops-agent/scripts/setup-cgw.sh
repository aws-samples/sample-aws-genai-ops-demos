...
#
# Usage: ./setup-cgw.sh <stack-name> <region> <key-file>
set -euo pipefail

STACK_NAME="${1:?Usage: $0 <stack-name> <region> <key-file>}"
REGION="${2:?Usage: $0 <stack-name> <region> <key-file>}"
KEY_FILE="${3:?Usage: $0 <stack-name> <region> <key-file>}"
